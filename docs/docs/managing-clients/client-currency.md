...
## System default vs explicit choice {#system-default-vs-explicit-choice}
...
## What the currency drives {#what-the-currency-drives}
...
## Changing a client's currency {#changing-a-clients-currency}
...
## Multi-currency in one workspace {#multi-currency-in-one-workspace}
...
## Custom currency codes {#custom-currency-codes}
