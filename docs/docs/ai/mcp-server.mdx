...
## Picking a company {#picking-a-company}
...
### Read tools (`mcp:read`) {#read-tools-mcpread}
...
### Write tools (`mcp:write`) {#write-tools-mcpwrite}
...
## Self-hosted: enabling the server {#self-hosted-enabling-the-server}
