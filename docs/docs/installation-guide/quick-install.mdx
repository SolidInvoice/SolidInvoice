...
<Tabs groupId="os">
  ...
  **One-liner install** — downloads the binary and installs it to `/usr/local/bin`:
  ...
  **Manual download** — grab the binary for your architecture from the [releases page](https://github.com/SolidInvoice/SolidInvoice/releases/latest), then make it executable and start it:
  ...
  :::tip
  On macOS, [Homebrew](./homebrew.md) is the easiest way to install and keep SolidInvoice up to date.
  :::
