...
:::info
Recurring tasks (such as recurring invoices) and async work (email sending, search indexing) run automatically — there is no separate cron job or messenger consumer to set up.
:::
