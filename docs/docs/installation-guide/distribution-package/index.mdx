...
description: Install SolidInvoice from the distribution archive on an existing PHP webserver, covering download, extraction, permissions, and the first-run setup wizard.
sidebar_position: 1
---
