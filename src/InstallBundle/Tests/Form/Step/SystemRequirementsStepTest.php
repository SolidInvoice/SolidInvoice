...
/**
 * @covers \SolidInvoice\InstallBundle\Form\Step\SystemRequirementsStep
 */
final class SystemRequirementsStepTest extends FormTestCase
{
    public function testSubmit(): void
    {
        $form = $this->factory->create(SystemRequirementsStep::class);

        // SystemRequirementsStep is an empty form, so it should just work with empty data
        $form->submit([]);
