...
final class WithinPlanInvoiceLimitValidatorTest extends ConstraintValidatorTestCase
{
    ...
    protected function createValidator(): WithinPlanInvoiceLimitValidator
    {
        ...
        $this->clock->method('now')->willReturn(CarbonImmutable::parse('2026-06-15'));

        return new WithinPlanInvoiceLimitValidator($this->invoiceRepository, $this->featureGate, $this->clock, $this->modeResolver, $this->entityManager);
    }
    ...
    public function testSkipsWhenNotSaas(): void
    {
        ...
        $this->validator = new WithinPlanInvoiceLimitValidator($this->invoiceRepository, $this->featureGate, $this->clock, $this->modeResolver, $this->entityManager);
