...
final class Info implements AjaxResponse
{
    ...
    public function __construct(private readonly Environment $twig, private readonly MoneyFormatterInterface $formatter, private readonly SystemConfig $systemConfig)
    {
    }
