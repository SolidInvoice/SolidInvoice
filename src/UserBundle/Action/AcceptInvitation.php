...
{
    public function __construct(private readonly UserInvitationRepository $repository, private readonly UserRepository $userRepository, private readonly RouterInterface $router)
    {
    }
