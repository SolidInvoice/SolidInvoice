...
class QuoteCreateListenerTest extends TestCase
{
    ...
    public function testStatusGetsUpdated()
    {
        ...
        $listener->setQuoteStatus(new \Symfony\Component\HttpKernel\Event\ViewEvent(M::mock(KernelInterface::class), $request, Kernel::MASTER_REQUEST, $entity));
    }
    ...
    public function testSkipIfNotMasterRequest()
    {
        ...
        $listener = new QuoteCreateListener($stateMachine);
        $request = Request::create('/', 'POST');
        $listener->setQuoteStatus(new \Symfony\Component\HttpKernel\Event\ViewEvent(M::mock(KernelInterface::class), $request, Kernel::SUB_REQUEST, new Quote()));
    }
    ...
    public function testSkipIfNoQuoteIsPassed()
    {
        ...
        $listener->setQuoteStatus(new \Symfony\Component\HttpKernel\Event\ViewEvent(M::mock(KernelInterface::class), $request, Kernel::MASTER_REQUEST, new Invoice()));
    }
    ...
    public function testSkipIfNotPostRequest()
    {
        ...
        $listener->setQuoteStatus(new \Symfony\Component\HttpKernel\Event\ViewEvent(M::mock(KernelInterface::class), $request, Kernel::MASTER_REQUEST, new Quote()));
    }
}
