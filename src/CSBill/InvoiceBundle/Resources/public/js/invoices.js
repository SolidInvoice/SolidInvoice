!function($, _, window){
    ...
    var Invoice = {
                    ...
                    "addRow" : function() {
                        ...
                        var rowTotal = $('.invoice-item-total', row);
                    ...
                    "setEvents" : function() {
                        $('.invoice-item-price, .invoice-item-qty').unbind('keyup change');
                         ...
                         $('.invoice-item-price, .invoice-item-qty').on('keyup', function(evt){
                             Invoice.calcTotal(this);
                         });

                         $('.invoice-item-qty').on('change', function(evt){
                             var qty = $(this),
                                 val = qty.val();
                         ...
                         $('.invoice-item-price').on('change', function(evt){
                             var price = $(this);
                    ...
                    "calcTotal" : function(row) {
                        ...
                        var price = accounting.unformat($('.invoice-item-price', tr).val()),
                    ...
                    "updateTotal" : function() {
                        ...
                        var discount = (subTotal * parseInt($('#invoice_discount').val() || 0) / 100);
