...
class Version20130411123146 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE app_config (id INT AUTO_INCREMENT NOT NULL, `key` VARCHAR(125) NOT NULL, `value` LONGTEXT DEFAULT NULL, description LONGTEXT DEFAULT NULL, section VARCHAR(125) NOT NULL, UNIQUE INDEX UNIQ_318942FC4E645A7E (`key`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
