...
return App::config([
    'sentry' => [
        ...
        'options' => [
            'send_default_pii' => env('SOLIDINVOICE_SENTRY_SEND_DEFAULT_PII')->bool(),
            ...
            'traces_sample_rate' => env('SOLIDINVOICE_SENTRY_TRACES_SAMPLE_RATE')->float(),
            ...
            'profiles_sample_rate' => env('SOLIDINVOICE_SENTRY_PROFILES_SAMPLE_RATE')->float(),
            ...
            'http_timeout' => env('SOLIDINVOICE_SENTRY_HTTP_TIMEOUT')->float(),
            'http_connect_timeout' => env('SOLIDINVOICE_SENTRY_HTTP_CONNECT_TIMEOUT')->float(),
