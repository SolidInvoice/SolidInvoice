 ...
 *     config: array{
 *         storage?: scalar|null, // Set the storage handler service // Default: null
 *         features?: array<string, scalar|null>,
 *     },
 * }
 ...
 *     without_overlapping_lock_factory?: scalar|null, // The LockFactory service to use for the without overlapping extension // Default: null
 *     single_server_lock_factory?: scalar|null, // The LockFactory service to use for the single server extension - be sure to use a "remote store" (https://symfony.com/doc/current/components/lock.html#remote-stores) // Default: null
 *     http_client?: scalar|null, // The HttpClient service to use // Default: null
 *     timezone?: scalar|null, // The default timezone for tasks (override at task level), null for system default // Default: null
 *     messenger?: bool|array{
 *         enabled?: bool, // Default: false
 *         message_bus?: scalar|null, // The message bus to use // Default: "message_bus"
 *     },
 *     mailer?: bool|array{
 *         enabled?: bool, // Default: false
 *         service?: scalar|null, // The mailer service to use // Default: "mailer"
 *         default_from?: scalar|null, // The default "from" email address (use if no mailer default from is configured) // Default: null
 *         default_to?: scalar|null, // The default "to" email address (can be overridden by extension) // Default: null
 *         subject_prefix?: scalar|null, // The prefix to use for email subjects (use to distinguish between different application schedules) // Default: null
 *     },
 *     notifier?: bool|array{
 *         enabled?: bool, // Default: false
 *         service?: scalar|null, // The notifier service to use // Default: "notifier"
 *         default_channel?: list<scalar|null>,
 *         default_email?: scalar|null, // The default email to use for email notification // Default: null
 *         default_phone?: scalar|null, // The default phone number to use for SMS notification // Default: null
 *         subject_prefix?: scalar|null, // The prefix to use for notifier subjects (use to distinguish between different application schedules) // Default: null
 *     },
 *     schedule_extensions?: array{
 *         environments?: list<scalar|null>,
 *         on_single_server?: bool|array{ // Run schedule on only one server
 *             enabled?: bool, // Default: false
 *             ttl?: int, // Maximum expected lock duration in seconds // Default: 3600
 *         },
 *         email_on_failure?: bool|string|array{ // Send email if schedule fails (alternatively enable by passing a "to" email)
 *             enabled?: bool, // Default: false
 *             to?: scalar|null, // Email address to send email to (leave blank to use "zenstruck_schedule.mailer.default_to") // Default: null
 *             subject?: scalar|null, // Email subject (leave blank to use extension default) // Default: null
 *         },
 *         notify_on_failure?: bool|array{ // Send notification if schedule fails (alternatively enable by passing a "channel")
 *             enabled?: bool, // Default: false
 *             channel?: list<scalar|null>,
 *             email?: scalar|null, // Email address for email notifications (leave blank to use extension default) // Default: null
 *             phone?: scalar|null, // Phone number for SMS notifications (leave blank to use extension default) // Default: null
 *             subject?: scalar|null, // Notification subject (leave blank to use extension default) // Default: null
 *         },
 *         ping_before?: bool|string|array{ // Ping a url before schedule runs (alternatively enable by passing a url)
 *             enabled?: bool, // Default: false
 *             url: scalar|null, // The url to ping
 *             method?: scalar|null, // The HTTP method to use // Default: "GET"
 *             options?: list<mixed>,
 *         },
 ...
 *         task: list<scalar|null>,
 *         frequency: scalar|null, // Cron expression
 *         description?: scalar|null, // Task description // Default: null
 *         timezone?: scalar|null, // The timezone for this task, null for system default // Default: null
 *         without_overlapping?: bool|array{ // Prevent task from running if still running from previous run
 *             enabled?: bool, // Default: false
 *             ttl?: int, // Maximum expected lock duration in seconds // Default: 86400
 *         },
 ...
 * }
 * @psalm-type SolidWorxPlatformUiConfig = array{
 *     icon_pack?: scalar|null, // The icon pack to use // Default: "tabler"
 *     templates?: array{
 *         base?: scalar|null, // The base template // Default: "@Ui/Layout/base.html.twig"
 *         login?: scalar|null, // The standard login template // Default: "@Ui/Security/login.html.twig"
 *     },
 * }
 ...
 * }
 * @psalm-type SolidWorxPlatformSaasConfig = array{
 *     doctrine: array{
 *         subscriptions: array{
 *             entity: scalar|null, // The class name of the subscription entity. This should be a fully qualified class name. This entity should implement SolidWorx\Platform\SaasBundle\Subscriber\SubscribableInterface
 *         },
 *         db_schema?: array{
 *             table_names?: array{
 *                 SolidWorx\Platform\SaasBundle\Entity\Plan?: scalar|null, // The table name for the Plan entity // Default: "saas_plan"
 *                 SolidWorx\Platform\SaasBundle\Entity\Subscription?: scalar|null, // The table name for the Subscription entity // Default: "saas_subscription"
 *                 SolidWorx\Platform\SaasBundle\Entity\SubscriptionLog?: scalar|null, // The table name for the Subscription logs entity // Default: "saas_subscription_log"
 *             },
 *         },
 *     },
 *     payment: array{
 ...
 *     integration: array{
 *         payment?: array{
 *             lemon_squeezy?: bool|array{
 *                 enabled?: bool, // Default: false
 *                 api_key: scalar|null, // Default: "env(LEMON_SQUEEZY_API_KEY)"
 *                 webhook_secret: scalar|null, // Default: "env(LEMON_SQUEEZY_WEBHOOK_SECRET)"
 *                 store_id: scalar|null, // Default: "env(LEMON_SQUEEZY_STORE_ID)"
 *             },
 *         },
 *     },
 * }
 ...
 *     },
 * }
 * @psalm-type SolidWorxPlatformConfig = array{
 *     doctrine?: array{
 *         types?: array{
 *             enable_utc_date?: bool, // Enable UTC date type. This ensures that all dates are stored in UTC format in the database. // Default: true
 *         },
 *     },
 *     models?: array{
 *         user?: scalar|null, // The User model class. // Default: "SolidWorx\\Platform\\PlatformBundle\\Model\\User"
 *     },
 * }
 ...
 *     solid_worx_platform_ui?: SolidWorxPlatformUiConfig,
 *     ux_icons?: UxIconsConfig,
 *     solid_worx_platform_saas?: SolidWorxPlatformSaasConfig,
 *     scheb_two_factor?: SchebTwoFactorConfig,
 *     solid_worx_platform?: SolidWorxPlatformConfig,
